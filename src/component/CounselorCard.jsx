export default function CounselorCard({ counselor, onBook }) {
 ...
 ₹{profile?.session_price} / session</span>
      ...
      <button
        className="mt-4 w-full cursor-pointer transition-all duration-300 bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg font-medium hover:-translate-y-1 hover:shadow-md"
